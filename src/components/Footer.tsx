  ...
  return (
    <footer className="h-24 px-[5%] border-t border-natural-border flex flex-col md:flex-row justify-between items-center bg-natural-footer transition-colors">
      <div className="flex items-center gap-6">
        <span className="text-[10px] uppercase tracking-[0.15em] opacity-50">Chapters:</span>
        <div className="flex items-center gap-8">
          <a
            href="https://www.instagram.com/henrytse113"
            target="_blank"
      ...
      <div className="flex items-center gap-8 text-right mt-4 md:mt-0">
        <div>
          <div className="text-[10px] uppercase tracking-widest opacity-40 mb-1">Project Management</div>
